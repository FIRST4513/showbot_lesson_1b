...
leftFrontMotor = new WPI_VictorSPX(4);
 
 

leftBackMotor = new WPI_VictorSPX(3);
 
 

leftMotorGrp = new MotorControllerGroup(leftFrontMotor, leftBackMotor  );
...
rightBackMotor = new WPI_VictorSPX(1);
 
 

rightMotorGrp = new MotorControllerGroup(rightFrontMotor, rightBackMotor  );
