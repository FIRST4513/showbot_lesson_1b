 ...
 *
 */
public class copilotDriveByJoystickCmd extends CommandBase {
    ...
    public copilotDriveByJoystickCmd(drivetrainSubSys subsystem) {
    ...
    public void initialize() {
        ...
        driveJoy = robot.getcopilotJoystick();
    }
